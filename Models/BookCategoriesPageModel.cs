...
namespace Costea_Dan_Lab8.Models
{
    public class BookCategoriesPageModell : PageModel
    {
        public List<AssignedCategoryData> AssignedCategoryDataList;
        public void PopulateAssignedCategoryData(Costea_Dan_Lab8Context context,
        Book book)
        {
        ...
        public void UpdateBookCategories(Costea_Dan_Lab8Context context,
